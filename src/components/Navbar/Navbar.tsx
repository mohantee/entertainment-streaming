  ...
  return (
    <nav className="navbar bg-semi-dark">
      ...
      <ul className="nav-links">
        ...
        <li>
          <Link to="/tv-series" title="TV Series">
            <div className="svg-group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
              ...
              >
                <path
                  ...
                  fill="#5A698F"
                  className={`path ${
                    currentLocation === "/tv-series" ? "active" : ""
                  }`}
                />
            ...
            <div className="svg-group">
              ...
              >
                <path
                  ...
                  fill="#5A698F"
                  className={`path ${
                    currentLocation === "/bookmarks" ? "active" : ""
                  }`}
                />
                <span className="sr-only">TV Shows</span>
              </svg>
